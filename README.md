...
version = "0.1.0"
description = ""
authors = ["YourNmae <your_mail@your_domain.ru>"]
readme = "README.md"
...
Теперь, если все настройки выполнены правильно и без ошибок, то ваш будет будет отвечать вам вашими же сообщениями
